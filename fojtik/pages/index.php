...
<main class="container">
   ...
   <ul class="list-group">
       <li class="list-group-item list-group-item-action active d-flex row">
           ...
           <span class="col-1"> gdsfsfsadf</span>
       </li>
   </ul>
   <?php foreach ($users as $user) : ?>
        ...
        <li class="list-group-item list-group-item-action d-flex row align-items-center">
            ...
            <div class="col-1 d-flex justify content-center">
                <a style="margin-right: Spx" href="../pages/profile.php<?php echo "?user=".$user["id"]; ?>"class="btn btn-success">Profil</a>
                <a href="../scripts/DeleteUser.php?id=<?php echo $user["id"];?>" class="btn btn-danger mr-2">Zmazat</a>
            </div>
        </li>
